...
class Game {
    constructor() {
        ...
        this.homeController = new HomeController(this.eventController, this.gameState);
        this.furnitureController = new FurnitureController(this.eventController, this.gameState);
